  ...
  return (
    ...
    >
      ...
      >
        <Link
          href="#contact"
          className="group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none transition focus:bg-gray-800 hover:bg-gray-800 active:bg-gray-700"
          onClick={() => {
